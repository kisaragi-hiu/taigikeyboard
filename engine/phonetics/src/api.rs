...
// Target writing system of a conversion: TL / POJ romanization, or TPS Bopomofo.
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum System {
    Tl,
    Poj,
...
// Public error type; the single unsupported-op variant usually means proto schema drift.
#[derive(Debug, Error)]
