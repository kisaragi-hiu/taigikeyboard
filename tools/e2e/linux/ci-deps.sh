...
#
# The linux/ build (Rust links GTK 4 / libadwaita and OpenSSL, the Fcitx5 addon needs its
...
case "${1:?usage: ci-deps.sh ubuntu|debian|fedora|arch}" in
    ...
    fedora)
        dnf install -y --setopt=install_weak_deps=False \
            ...
            gtk4-devel libadwaita-devel openssl-devel pkgconf-pkg-config unzip findutils which \
    ...
    arch)
        pacman -Syu --noconfirm --needed \
            ...
            gtk3 gtk4 libadwaita openssl pkgconf unzip rustup \
