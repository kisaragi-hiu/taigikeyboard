...
- **Unchanged**: the nailed-prefix join between picks (§51, its own policy on `NailedSegment.raw_text`); learned phrases (§50, `learned_joiner`); TPS; English.
