...
- **Unchanged**: `khiah` with nothing typed keeps every reading; TPS (§35 / §41 — the whole-buffer pin still reads the space barriers only, so `ㄒㄧ-` pins nothing) and the §34 literal; English; the 連字 / 輕聲 rendering rules (#129, §51).
