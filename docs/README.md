...
| `reports/2026-09-21-taile-mode-tone-commit.md` | 臺羅模式 — tone key commits without a candidate window (MOE Mac IME parity): why marked text stays, desktop-only Enter cost under 候選詞顯示 = 羅馬字, options A (Space commits when `.ignored`) / B (real 臺羅模式) costed, open USER decisions — research only, low priority (USER 2026-09-21) | Plan |
